...
export function ProjectHeader({ project }: Props) {
  return (
    <header className="relative shrink-0 border-b border-primary/20 bg-background/40 p-6 pb-6 backdrop-blur-xl z-10 glass-dark structural-corner">
      ...
      <Link href="/projects">
        ...
        >
          <Button variant="ghost" size="sm" className="mb-4 -ml-2 text-[10px] font-mono font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-mono font-black uppercase tracking-[0.25em] text-muted-foreground/40">
        ...
        <div className="flex items-center gap-6">
          <ThemeToggle />
          <div className="flex flex-col items-end text-right border-l border-primary/10 pl-6 h-10 justify-center">
            <div className="mb-1 text-[9px] font-mono font-black uppercase tracking-[0.25em] text-primary/40">
              [SCHED.BASELINE_EST]
            </div>
